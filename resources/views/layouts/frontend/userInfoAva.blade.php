<div class="row py-2 mt-2 px-lg-5 mx-1" id="background-infor">
    ...
    <object data="{{asset('profile/'.Auth::user()->avatar)}}" class="rounded-circle" width="125px" type="image/png">
        <img src="{{Auth::user()->avatar}}" alt="image profile" class="rounded-circle" width="125px">
    </object>
    @else
    <img src="{{asset('profile/default_av.png')}}" alt="image profile" class="rounded-circle" width="125px">
    @endif
