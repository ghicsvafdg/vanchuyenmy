...
<div class="row">
    <div class="card col-7">
        ...
        <p>[vị trí hiển thị]--[trạng thái hiển thị]</p>
        <div class="card-body">
            <ul>
                ...
                <li>
                    <div class="row">
                        <div class="col-8">
                            [{{$category->order}}] -- [{{$category->status}}] -- {{ $category->title }} -- <i class="{{$category->icon}}"></i>
                        </div>
                        <div class="col-1">
                            <a href="{{route('manage-product-category.edit', $category->id)}}" class="btn btn-sm btn-secondary btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit"> 
                    ...
                    @include('backend.manageChildProduct',['childs' => $category->childs])
                    @endif
    ...
    <div class="card col">
        ...
        <div class="card-body">
            <form action="{{route('manage-product-category.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Icon</label>
                    <input type="text" class="form-control" name="icon" placeholder="copy text ở bảng icon phía dưới để điền">
                </div>
                <div class="form-group">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="col-6">
                    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Tìm icon" class="form-control">
                </div>
        ...
        var initDemos = function() {
            $('.btn-danger').click(function(e) {
                ...
                swal({
                    ...
                    text: "Danh mục đã xóa sẽ xóa toàn bộ danh mục con và sản phẩm thuộc danh mục này!",
                    type: 'warning',
                    buttons:{
                        confirm: {
                            text : 'Có, Xóa đi!',
...
<script >
    ...
    for (i = 0; i < iconClass.length; i++){
        $(rowDemoIcon).append('<div class="col-md-3"><i class="' + iconClass[i] + '"></i><p>' + iconClass[i] + '</p></div >');
    }
</script>
<script>
    function myFunction() {
        ...
        div = document.getElementById("row-demo-icon");
