            ...
            <div class="table-responsive">
                ...
                <table id="basic-datatables" class="display table table-striped table-hover" style="width:100%">
                    ...
                    <thead>
                        <tr>
                            <th>
                                STT{{-- <input type="checkbox" onClick="toggle(this)" class="checkall"/><br/> --}}
                            </th>
                            <th>Tên sản phẩm</th>
                            <th>Ảnh</th>
                            <th>Danh mục</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="30%">  
                                <a href="{{route('index.show',$pr->id)}}">{{$pr->name}}</a>
                            </td>
                            <td>
                            ...
                            <td>
                                {{number_format( $pr->price, 0, ',', ' ' )}} 000đ
                            </td>
                            <td>
                                @isset($pr->promotion)
                                {{number_format( $pr->promotion, 0, ',', ' ' )}} 000đ
                                @endisset
                            </td>
                            <td>
                                @if ($pr->status == 1)
                            ...
                            <td class="mt-2 navbar-nav text-center">
                                <li class="nav-item dropdown hidden-caret noExl">
                                    ...
                                    <ul class="dropdown-menu dropdown-user animated fadeIn" style="width:10%">
                                        <li>
                                            <div>
                                                <a class="dropdown-item btn-primary text-center btn-link" href="{{route('manage-product.show', $pr->id)}}" data-toggle="tooltip" data-placement="bottom"  title="View">
